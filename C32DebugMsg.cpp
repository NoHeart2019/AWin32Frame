...
static CHAR* GetGenericNotifyString(int NotifyCode)
{
	CHAR* Str;
...
static CHAR* GetListViewNotifyString(int Nm)
{
	PCHAR Str;
...
VOID C32DbgOutListViewNotify(int Nm)
{
	...
	Str = GetListViewNotifyString(Nm);
...
WCHAR* GetSystemColorToString(ULONG Flag)
{
	...
	case CTLCOLOR_MSGBOX :
		return L"CTLCOLOR_MSGBOX /COLOR_SCROLLBAR";
	case CTLCOLOR_EDIT :
		return L"CTLCOLOR_EDIT / COLOR_BACKGROUND /COLOR_DESKTOP";
	case CTLCOLOR_LISTBOX :
		return L"CTLCOLOR_LISTBOX / COLOR_ACTIVECAPTION";
	case CTLCOLOR_BTN :
		return L"CTLCOLOR_BTN / COLOR_INACTIVECAPTION";
	case CTLCOLOR_DLG :
		return L"CTLCOLOR_DLG / COLOR_MENU";
	case CTLCOLOR_SCROLLBAR :
		return L"CTLCOLOR_SCROLLBAR / COLOR_WINDOW";
	case CTLCOLOR_STATIC :
		return L"CTLCOLOR_STATIC / COLOR_WINDOWFRAME";
	case CTLCOLOR_MAX :
		return L"CTLCOLOR_MAX / COLOR_MENUTEXT";
	
	case COLOR_WINDOWTEXT :
		return L"COLOR_WINDOWTEXT";
	case COLOR_CAPTIONTEXT :
		return L"COLOR_CAPTIONTEXT";
	case COLOR_ACTIVEBORDER :
		return L"COLOR_ACTIVEBORDER";
	case COLOR_INACTIVEBORDER :
		return L"COLOR_INACTIVEBORDER";
	case COLOR_APPWORKSPACE :
		return L"COLOR_APPWORKSPACE";
	case COLOR_HIGHLIGHT :
		return L"COLOR_HIGHLIGHT";
	case COLOR_HIGHLIGHTTEXT :
		return L"COLOR_HIGHLIGHTTEXT";
	case COLOR_BTNFACE :
		return L"COLOR_BTNFACE";
	case COLOR_BTNSHADOW :
		return L"COLOR_BTNSHADOW";
	case COLOR_GRAYTEXT :
		return L"COLOR_GRAYTEXT";
	case COLOR_BTNTEXT :
		return L"COLOR_BTNTEXT";
	case COLOR_INACTIVECAPTIONTEXT :
		return L"COLOR_INACTIVECAPTIONTEXT";
	case COLOR_BTNHIGHLIGHT :
		return L"COLOR_BTNHIGHLIGHT";
	case COLOR_3DDKSHADOW :
		return L"COLOR_3DDKSHADOW";
	case COLOR_3DLIGHT :
		return L"COLOR_3DLIGHT";
	case COLOR_INFOTEXT :
		return L"COLOR_INFOTEXT";
	case COLOR_INFOBK :
		return L"COLOR_INFOBK";
	case COLOR_HOTLIGHT :
		return L"COLOR_HOTLIGHT";
	case COLOR_GRADIENTACTIVECAPTION :
		return L"COLOR_GRADIENTACTIVECAPTION";
	case COLOR_GRADIENTINACTIVECAPTION :
		return L"COLOR_GRADIENTINACTIVECAPTION";
	case COLOR_MENUHILIGHT :
		return L"COLOR_MENUHILIGHT";
	case COLOR_MENUBAR :
		return L"COLOR_MENUBAR";
	default : 
		break; 
	}
	return L"Invalide Value";
}
